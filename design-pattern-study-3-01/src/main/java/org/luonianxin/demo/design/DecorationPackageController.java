package org.luonianxin.demo.design;
...
public class DecorationPackageController {
    ...
    public String getMatterList(BigDecimal area, Integer level) {
        ...
        for(Matter matter : list){
            detail.append(matter.brand()).append(": ").append(matter.brand()).append(": ").append(matter.model()).append(": ").append("、平米价格：").append(matter.price()).append("元。\n");
        }
